...
% Save Plot
saveas(gcf,['Figures/S20_Space_2N'],'pdf')
...
% Save Plot
saveas(gcf,['Figures/S20_Space_3N'],'pdf')
...
% Save Plot
saveas(gcf,['Figures/S20_Space_FB'],'pdf')
...
% Save Plot
saveas(gcf,['Figures/S20_Space_BuiltConfigs'],'pdf')
