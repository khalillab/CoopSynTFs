...
% Matlab R2013a
% 1D Interpolation of 43-8 TF-DNA interactions with clamp

OutputName = '181119_43_8_interp';
...
TFrange = logspace(-6,0,500)';              % TF [] range (µM)
...
% Create Space
params = combvec(Kt_438_approx_range, Kp_approx_range, N_range);
