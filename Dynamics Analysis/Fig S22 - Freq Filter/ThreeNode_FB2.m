function dxdt = ThreeNode_FB2(t,x,time,DOX,k1,k2,k3,kdeg_TF1,kdeg_TF2,kdeg_GFP,kb_gabor,kb_cyc1,kb_cyc2,func1,func2)

%% Network Structure
% Dox -> TF1; TF1xTF2 -> TF2; TF2 -> GFP
...
%d[GFP]/dt
Therm2 = func2(TF2*10^-6);                  % Interpolation of thermodynamic model
